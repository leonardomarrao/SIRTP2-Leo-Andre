...
export default {
  ...
  methods: {
    setPlatPS: function () {
      ...
      this.$store.commit("setPlataforma", plataforma); 
      console.log("PLATAFORMA mudou para: " + this.$store.getters.getPlataforma);
    },
    setPlatXB: function () {
      var plataforma = "xbox"
      this.$store.commit("setPlataforma", plataforma);
